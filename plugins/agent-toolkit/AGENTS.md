...
| Code review | `$code-review`: Assess the diff against both repository standards and the requested behavior. Keep correctness and standards findings distinct, fix concrete defects, and verify the resulting changes. |
